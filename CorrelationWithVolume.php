...
$apple_news_query = "SELECT (Count/10) as count from 2018S_brai.News where Symbol='AAPL' and Date>='2018-02-14' and Date<='2018-02-26'";
...
$google_news_query = "SELECT (Count/10) as count from 2018S_brai.News where Symbol='GOOG' and Date>='2018-02-14' and Date<='2018-02-26'";
...
$sony_news_query = "SELECT (Count/10) as count from 2018S_brai.News where Symbol='SNE' and Date>='2018-02-14' and Date<='2018-02-26' ";
...
$apple_volume_query = "SELECT (Volume/10000000) as volume from 2018S_kasturim.Stocks where symbol='AAPL' and date>='2018-02-14' and date<='2018-02-26' ";

$apple_volume_result = mysqli_query($conn,$apple_volume_query);
if($apple_volume_result){
  if ($apple_volume_result->num_rows > 0) {        
    while( $row = mysqli_fetch_array($apple_volume_result) ){            
      $appleVolume[] = $row['volume'];
    }
  }
  else{
    echo"<br>No records in the database.\n";
    mysqli_free_result($apple_volume_result);
  }
}
else{ 
  echo"<br>No result set return from the database.\n";   
}
$google_volume_query = "SELECT (Volume/10000000) as volume from 2018S_kasturim.Stocks where symbol='GOOGL' and date>='2018-02-14' and date<='2018-02-26' ";

$google_volume_result = mysqli_query($conn,$google_volume_query);
if($google_volume_result){
  if ($google_volume_result->num_rows > 0) {        
    while( $row = mysqli_fetch_array($google_volume_result) ){            
      $googleVolume[] = $row['volume'];
    }
  }
  else{
    echo"<br>No records in the database.\n";
    mysqli_free_result($google_volume_result);
  }
}
else{ 
  echo"<br>No result set return from the database.\n";   
...
$sony_volume_query = "SELECT (Volume/10000000) as volume from 2018S_kasturim.Stocks where symbol='SNE' and date>='2018-02-14' and date<='2018-02-26' ";

$sony_volume_result = mysqli_query($conn,$sony_volume_query);
if($sony_volume_result){
  if ($sony_volume_result->num_rows > 0) {        
    while( $row = mysqli_fetch_array($sony_volume_result) ){            
      $sonyVolume[] = $row['volume'];
    }
  }
  else{
    echo"<br>No records in the database.\n";
    mysqli_free_result($sony_volume_result);
  }
}
else{ 
  echo"<br>No result set return from the database.\n";   
...
$app_news_volume_correlation = correlation($appleNews,$appleVolume);
$goo_news_volume_correlation = correlation($googleNews,$googleVolume);
$sony_news_volume_correlation = correlation($sonyNews,$sonyVolume);
...
echo "Apple News vs Stock Volume Correlation: ",$app_news_volume_correlation,"<br/>";
echo "Google News vs Stock Volume Correlation: ",$goo_news_volume_correlation,"<br/>";
echo "Sony News vs Stock Volume Correlation: ",$sony_news_volume_correlation,"<br/>","<br/>";
?>